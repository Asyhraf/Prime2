...
<div class="animated fadeIn">
    <div class="card">
        <div class="card-header">
            <h3 class="text-center"><b>SURAT EDARAN DOKUMEN MESYUARAT</b></h3>
        </div>

        <div class="card-body">

            <form class="form" action="{{ route('m_EdaranDokumen')}}">
                ...
                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <td style="text-align: center">
                            ...
                            <a title="Cetak Surat Edaran Dokumen Mesyuarat {{ $event->title }}" class="btn btn-success btn-sm rounded-circle" href="{{ route('m_CetakanEdaranDokumen_ksukp',$event->id) }}">
                                <i class="fa fa-print"></i>
                            </a>
                            @elseif($event->title == 'MBKM')
                            <a title="Cetak Surat Edaran Dokumen Mesyuarat {{ $event->title }}" class="btn btn-success btn-sm rounded-circle" href="{{ route('m_CetakanEdaranDokumen_mbkm',$event->id) }}">
                                <i class="fa fa-print"></i>
                            </a>
                            @endif
                        </td>
