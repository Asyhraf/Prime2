    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <body>
                ...
                <form class="theme-form mega-form" method="POST" action="{{ route('kemaskini_kehadiran', ['id' => $event->id]) }}">
                    {{ csrf_field() }}
                    ...
                    <table id="bootstrap-data-table-export1" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <td>
                                <strong>{{ $ahli->nama_ahli }}</strong>
                                <br>{{ $ahli->nama_jawatan }}
                                @if(!empty($ahli->nama_kementerian))
                                <br>{{ $ahli->nama_kementerian }}
                                @endif
                            </td>
                            ...
                            <td style="text-align: center">
                                @if(!empty($ahli->nama_gred))
                                    {{ $ahli->nama_gred }}
                                    <br>{{ date('d/m/Y', strtotime($ahli->tarikh_lantikan)) }}
                                @else
                            ...
                            <td><strong>
                                    ...
                                    <div class="form-group" style="text-align: center">
                                        ...
                                        <input style="width:9%;" type="radio" id="yes" name="kehadiran[{{ $counter }}]" onclick="hideInputDiv({{ $counter }})" value="Y" {{ $ahli->kehadiran == 'Y' ? 'checked' : '' }}>

                                        <label class="col-form-label" for="css">TIDAK HADIR</label>
                                        <input style="width:9%;" type="radio" id="no" name="kehadiran[{{ $counter }}]" onclick="addmentor({{ $counter }})" value="N" {{ $ahli->kehadiran == 'N' ? 'checked' : '' }}>
                                    ...
                                    <div id="myDIV{{ $counter }}">
                                        ...
                                        GRED WAKIL
                                        <select class="form-control" name="id_gred_wakil[{{ $counter }}]" id="id_gred_wakil" value="{{ $ahli->id_gred_wakil }}">
