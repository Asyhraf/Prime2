...
<body>
    <div class="Section1">
        ...
        <table border="0" width="100%" class="" cellspacing="0" cellpadding="0" style="border-collapse:collapse; border-color:#000000;">
            <tbody>
                <tr>
                    <td class="" width="100%" colspan="0" style="border-top:none;border-bottom:none;border-left:none;border-right:none;" align="right">BKPP.R.600-13/1/1 Jld.17 (XXX)</td>
                </tr><br />
            </tbody>
        </table>
        ...
        <table border="0" width="100%" class="" cellspacing="0" cellpadding="0" style="border-collapse:collapse; border-color:#000000;">
            <tbody>
                <tr>
                    <td class="" width="100%" colspan="0" style="border-top:none;border-bottom:none;border-left:none;border-right:none;" align="left">Yang Amat Berhormat, </td>
                </tr><br />
            </tbody>
        </table>
        ...
        <table border="0" width="100%" class="" cellspacing="0" cellpadding="0" style="border-collapse:collapse; border-color:#000000;">
            <tbody>
                <tr>
                    <td class="" width="100%" colspan="0" style="border-top:none;border-bottom:none;border-left:none;border-right:none;" align="justify"><b>Mesyuarat Menteri Besar Dan Ketua Menteri Kali Ke {{ $event->meeting_numbers }} </b></td>
                    <span><b>--------------------------------------------------------------------------------</b></span>
                </tr><br /><br />
            </tbody>
        </table>
                ...
                <tr>
                    <td>
                        <p style="text-align: justify">
                            <span>Saya dengan hormatnya memaklumkan bahawa Mesyuarat Menteri Besar dan
                                Ketua Menteri (MBKM) Ke-141 akan diadakan seperti ketetapan yang berikut :
                            </span>
                        </p>
                    </td>
                </tr>
        ...
        <table border="0" width="100%" height="10%" class="" cellspacing="0" cellpadding="0" style="border-collapse:collapse; border-color:#000000;">
            <tbody>
                <tr style="height: 30px;">
                    <td class="" width="8.5%" align="left"><b></b></td>
                    <td class="" width="16%" align="left"><b>Tarikh</b></td>
                    <td class="" width="4%" align="center"><b>:</td></b>
                    <td class="" width="6%" align="center"><b></td></b>
                    <td class="" width="40%" align="left"><b>{{ $event_start->isoFormat('dddd, D MMMM YYYY') }} </td></b>
                    <td class="" width="29.5%" align="left"><b></b></td><br />
                </tr>
                <tr style="height: 30px;">
                    <td class="" width="8.5%" align="left"><b></b></td>
                    <td class="" width="16%" align="left"><b>Masa</b></td>
                    <td class="" width="4%" align="center"><b>:</td></b>
                    <td class="" width="6%" align="center"><b></td></b>
                    <td class="" width="40%" align="left"><b>{{$event_time1->format('h.i')}}
                            {{
                ...
                <tr style="height: 45px;">
                    <td class="" width="8.5%" align="left"><b></b></td>
                    <td class="" width="16%" valign="top" align="left"><b>Tempat</b></td>
                    <td class="" width="4%" valign="top" align="center"><b>:</b></td>
                    <td class="" width="6%" align="center"></td>
                    <td class="" width="40%" valign="top" align="left"><b>{{ $event->location }}</b></td>
                    <td class="" width="29.5%" align="left"><b></b></td><br />
                </tr>
                <tr style="height: 30px;">
                    <td class="" width="8.5%" align="left"><b></b></td>
                    <td class="" width="16%" align="left"><b>Pengerusi</b></td>
                    <td class="" width="4%" align="center"><b>:</td></b>
                    <td class="" width="6%" align="center"><b></td></b>
                    <td class="" width="40%" align="left"><b>YAB Perdana Menteri</td></b>
                    <td class="" width="29.5%" align="left"><b></b></td><br />
                </tr>
            </tbody>
        </table>
        ...
        <p style="text-align: justify">
            <span>3.&emsp;&emsp;Bagi maksud perancangan dan penyelarasan, kerjasama Yang Amat <br />
                ...
                <u><b>http://broga.kabinet.gov.my/prime2.0/public/m_QRCode/{{ $event->ahli_id }}/{{ $event->id }}</b></u>
                atau mengimbas kod QR di bawah sebelum atau pada <u><b>{{ $event_start->isoFormat('dddd, D MMMM YYYY') }}.</b></u></span><br />
        </p>
    ...
    <table border="0" width="100%" class="" cellspacing="0" cellpadding="0" style="border-collapse:collapse; border-color:#000000;">
        <tbody>
            <tr>
                <td class="" width="100%" colspan="0" style="border-top:none;border-bottom:none;border-left:none;border-right:none;" align="left"><u><b>Hadir Bersama:</b></u></td>
            </tr><br />
        </tbody>
    </table>
    ...
    <table border="0" width="100%" class="" cellspacing="0" cellpadding="0" style="border-collapse:collapse; border-color:#000000;">
        <tbody>
            <tr>
                <td class="" width="100%" colspan="0" style="border-top:none;border-bottom:none;border-left:none;border-right:none;" align="left">YB Setiausaha Kerajaan Negeri Sabah<br /><br />
    ...
    <table border="0" width="100%" class="" cellspacing="0" cellpadding="0" style="border-collapse:collapse; border-color:#000000;">
        <tbody>
            <tr>
                <td class="" width="100%" colspan="0" style="border-top:none;border-bottom:none;border-left:none;border-right:none;" align="left"><u><b>Turut Hadir:</b></u></td>
            </tr><br />
        </tbody>
    </table>
    ...
    <table border="0" width="100%" class="" cellspacing="0" cellpadding="0" style="border-collapse:collapse; border-color:#000000;">
        <tbody>
            <tr>
                <td class="" width="100%" colspan="0" style="border-top:none;border-bottom:none;border-left:none;border-right:none;" align="left">YBhg. Peguam Negara<br /><br />
...
header("Content-Disposition: attachment;Filename=m_CetakanPanggilanMesyuarat_mbkm.doc");
?>
