...
<body>
<div class="pstyle2">
Senarai Kehadiran Ahli {{ $event->TajukMesyuarat->nama_tajuk }} ({{ $event->title }}) Bilangan {{ $event->meeting_numbers }} Tahun {{ $event->year }}
</div>
<br><br>
<table width="950">
<thead>
...
header("Content-Disposition: attachment;Filename=m_cetakanTidakKehadiran ($event->title Bil $event->meeting_numbers/ $event->year).doc");
?>