...
<div class="animated fadeIn">
    <div class="card">
        <div class="card-header">
            <h3 class="text-center"><b>AGENDA MESYUARAT</b></h3>
        </div>

        <div class="card-body">
            <form class="form" action="{{ route('m_AgendaMesyuarat')}}">
            ...
            <body>
                ...
                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <td style="text-align: center"><strong>{{ date('d/m/Y', strtotime($event->start)) }}</strong></td>
                        ...
                        <td style="text-align: center">
                            ...
                            <a title="Agenda Mesyuarat {{ $event->title }}" class="btn btn-success btn-sm rounded-circle" href="{{ route('m_CetakanAgendaMesyuarat_ksukp', $event->id) }}">
                                <i class="fa fa-print"></i>
                            </a>
                            @elseif($event->title == 'MBKM')
                            <a title="Agenda Mesyuarat {{ $event->title }}" class="btn btn-success btn-sm rounded-circle" href="{{ route('m_CetakanAgendaMesyuarat_mbkm', $event->id) }}">
                                <i class="fa fa-print"></i>
                            </a>
                            @endif
                        </td>
