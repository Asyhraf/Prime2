...
<body>
    <div class="animated fadeIn">
        <div class="card">
            <form class="theme-form mega-form" method="POST" action="{{ route('emel.panggilan.mbkm') }}">
                @csrf
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-control editable-div" id="displaymessage" name="displaymessage" contenteditable="true">
                                <p style="text-align: justify">
                                    Yang Amat Berhormat,<br><br>

                                    <u><strong>{{ $event->TajukMesyuarat->nama_tajuk }} Kali Ke-{{ $event->meeting_numbers }}</strong></u><br><br>

                                    Saya dengan hormatnya memaklumkan bahawa Mesyuarat Menteri Besar dan Ketua Menteri (MBKM) Ke-{{ $event->meeting_numbers }} akan diadakan seperti ketetapan berikut:
                                </p>
                                ...
                                <br>
                                <p style="text-align: justify">
                                    2. &emsp;&emsp;Yang Amat Berhormat dengan segala hormatnya dijemput hadir bersama-sama Yang Berhormat Setiausaha Kerajaan Negeri.
                                </p>

                                <p style="text-align: justify">
                                    3. &emsp;&emsp;Bagi maksud perancangan dan penyelarasan, kerjasama Yang Amat Berhormat dimohon untuk mengesahkan kehadiran melalui pautan<br>
                                    <b>URL: <u>http://broga.kabinet.gov.my/prime2.0/public/m_QRCode/{{ $ahli->ahli_id }}/{{ $event->id }}</u></b>
                                ...
                                <p>
                                    ...
                                    <strong>URUS SETIA MESYUARAT MBKM</strong>
                                </p>
                            </div>
