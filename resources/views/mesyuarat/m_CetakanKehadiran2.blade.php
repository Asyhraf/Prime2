...
<body style='tab-interval:.5in'>
	<div class="Section1">
		...
		<p style="text-align: center">
            <b>SENARAI KEHADIRAN AHLI MESYUARAT (HADIR)<br>
		...
		<table width="100%" cellspacing="0" cellpadding="0" id="table1">
			<thead>
				<tr>
					<th width="7%" valign="top" style="text-align: center"><b><u>BIL</u></b></th>
					<th width="73%" valign="top" style="text-align: center"><b><u>NAMA DAN JAWATAN</u></b></th>
					<th width="20%" valign="top" style="text-align: center"><b><u>GRED</u></b><br><br></th>
				</tr>
			</thead>
...
header("Content-Disposition: attachment;Filename=SENARAI_KEHADIRAN ($event->title Bil $event->meeting_numbers- $event->year).doc");
?>
