...
<div class="animated fadeIn">
    <div class="card">
        ...
        <div class="card-header">
            <h3 class="text-center"><b>KEMASKINI KEMENTERIAN</b></h3>
        </div>
        ...
        <form class="theme-form mega-form" method="POST">
            ...
            <div class="col-sm-12 col-xl-12">
                ...
                <input class="form-control" type="text" name="nama_kementerian" placeholder="" value="{{ $ref_kementerian->nama_kementerian }}">
                </div>

                <div class="form-group">
                <label class="col-form-label">SINGKATAN KEMENTERIAN</label>
                <input class="form-control" type="text" name="singkatan_kementerian" placeholder="" value="{{ $ref_kementerian->singkatan_kementerian }}">
                </div>
