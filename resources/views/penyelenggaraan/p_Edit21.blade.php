...
<div class="container-fluid">
  <form class="theme-form mega-form" method="POST">
          ...
          <div class="col-sm-12">
            <div class="card">
              <!-- <div class="card-header">
                <h3 style="text-align:center">AHLI MESYUARAT</h3>
              </div> -->
              <div class="card-body">
                ...
                <div class="form-group">
                  <label class="col-form-label">JENIS MESYUARAT</label><br>
                ...
                <!-- <script>
                    var id_jawatan = $ahli_mesyuarat->Jawatan->id_jawatan;
                    var options = "";
                    for(var y=0; y<=id_jawatan; y++){
                      options += "<option>"+ y +"</option>";
                    }
                    document.getElementById("id_jawatan").innerHTML = options;
                  </script>

                  <select class="form-control" name="jawatan" id="jawatan" value="jawatan">
                    <option value="id_jawatan"></option>
                  </select> -->
    ...
    <button class="btn btn-secondary" type="reset" name="reset" class="button" value="reset">Tetapan Semula</button>
</div>
@endsection
</div>
</form>
