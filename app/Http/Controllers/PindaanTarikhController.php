...
class PindaanTarikhController extends Controller
{
    ...
    public function indexPindaan(Request $request)
    {
        ...
        return view('mesyuarat.m_PindaanTarikh')->with(compact('title', 'tahun', 'eventTitle'));
    }

    public function cetakanpindaantarikhmesyuarat_ksukp(Request $request, $id)
    {
        ...
        $pindaan_tarikh =  AhliEvent::join('butiran_ahli_mesyuarat', 'ahli_event.ahli_id', '=', 'butiran_ahli_mesyuarat.id_ahli')
        ...
        return view('mesyuarat.m_CetakanPindaanTarikhMesyuarat_ksukp')->with(compact('event', 'pindaan_tarikh', 'event_start', 'event_time1', 'event_time2'));
    }
    public function cetakanpindaantarikhmesyuarat_mbkm(Request $request, $id)
    {
        $event = Event::whereid($id)->firstOrFail();
        $event_start = Carbon::parse($event->start)->locale('ms_MY');
        $event_time1 = Carbon::parse($event->time1)->locale('ms_MY');
        ...
        return view('mesyuarat.m_CetakanPindaanTarikhMesyuarat_mbkm')->with(compact('event', 'pindaan_tarikh', 'event_start', 'event_time1', 'event_time2'));
    }
}
